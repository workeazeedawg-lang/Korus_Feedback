...
class SheetWebhookClient:
    ...
    def append_feedback(self, record: FeedbackRecord) -> None:
        feedback_row = [
            ...
            record.comms_rating,
            record.requirement_understanding,
            record.first_candidate_relevant,
            record.relevance_rating,
            record.process_clarity_rating,
            record.timeliness_rating,
            record.improvement_priority,
            record.recommend_recruiter,
            record.closed_date,
            record.job_url,
        ]
        payload = {
            ...
            "requirement_understanding": record.requirement_understanding,
            "first_candidate_relevant": record.first_candidate_relevant,
            "relevance_rating": record.relevance_rating,
            "process_quality_rating": record.process_quality_rating,
            "process_clarity_rating": record.process_clarity_rating,
            "improvement_priority": record.improvement_priority,
            "recommend_recruiter": record.recommend_recruiter,
            ...
            "columns": [
                ...
                "Рекомендовали бы рекрутера? (Да/Нет)",
